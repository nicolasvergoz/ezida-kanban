# Card Writing Specification

## Purpose

CLI surface for mutating commands: `ezida add`, `ezida move`, `ezida rm`. Includes the interactive confirmation prompt and TTY abstraction.
