# landing-page-responsive Specification

## Purpose

The public landing page at `site/` must remain usable and free of horizontal overflow at common mobile and tablet viewport widths.
