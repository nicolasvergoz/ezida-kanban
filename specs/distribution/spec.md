...
End-user distribution: POSIX install.sh (platform detection, checksum verification, install to ~/.local/bin), GitHub Actions workflows (CI on push/PR, release on tag), README, MIT LICENSE.
